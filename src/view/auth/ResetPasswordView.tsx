...
const ResetPasswordView = () => {
  ...
  const handleSubmit = async (data: PasswordFormData) => {
    ...
    if (successResult.data && successResult.data.success) {
      setIsSubmitted(true);
      setSubmitting(false);
      toast.success(successResult.data.message || 'Password updated successfully');
        ...
        <WkForm resolver={zodResolver(passwordSchema)} onSubmit={handleSubmit}>
          ...
          <div className="bg-muted my-6 rounded-xl p-4">
            <p className="text-muted-foreground text-xs leading-relaxed">
              <span className="text-primary mb-1 block font-semibold">Security Tip:</span>
              Password should be at least 8 characters long and include uppercase, lowercase,
