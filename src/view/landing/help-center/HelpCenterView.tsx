      ...
      <section className="from-primary/10 via-primary/5 relative overflow-hidden bg-linear-to-b to-transparent pt-20 pb-12 sm:pt-32 sm:pb-20 md:pt-40 md:pb-28">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="text-muted-foreground mx-auto mt-4 max-w-xl text-base sm:text-lg">
            Search our knowledge base for instant answers or select one of the core support
            categories below.
          </p>
      ...
      <div className="mx-auto max-w-7xl px-4 pb-14 sm:px-6 sm:pb-28 lg:px-8">
        ...
        <div id="faq-section" className="max-w-3.5xl mx-auto scroll-mt-24">
          <div className="mb-6 text-center sm:mb-10">
            ...
            <p className="text-muted-foreground mt-2 text-sm sm:text-base">
              Quick answers to common questions about Workly platform operations.
            </p>
          ...
          {filteredFaqs.length > 0 ? (
            ...
            <div className="border-border/50 bg-card rounded-2xl border py-16 text-center">
              ...
              <h3 className="text-foreground mt-4 text-lg font-bold">No matching results found</h3>
              <p className="text-muted-foreground mx-auto mt-2 max-w-xs text-sm">
                We {`couldn't`} find any FAQs for {`"${searchQuery}"`}. Try updating your keywords
                or resetting the filter.
              </p>
              <Button
                variant="outline"
                onClick={() => {
        ...
        <div className="bg-primary/5 border-primary/10 relative mx-auto mt-14 max-w-4xl overflow-hidden rounded-2xl border p-5 text-center shadow-xs transition-all duration-500 hover:shadow-md sm:mt-28 sm:rounded-3xl sm:p-12">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl font-extrabold tracking-tight">Still need support?</h2>
            <p className="text-muted-foreground mx-auto mt-3 max-w-xl text-base">
              {`Can't`} find the resolution to your query in our documentation? Contact our global
              service desk.
            </p>
