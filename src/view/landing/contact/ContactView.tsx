      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-muted-foreground mx-auto mt-4 max-w-2xl text-base sm:text-lg lg:mx-0">
            Have questions about Workly_job? Whether {`you're`} a job seeker or an employer, our
            global support team is ready to assist you.
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="bg-primary/5 border-primary/10 rounded-2xl border p-5 transition-shadow duration-500 hover:shadow-xs sm:rounded-3xl sm:p-8">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed sm:text-base">
                Check our Help Center for quick answers to common questions about account setup, job
                postings, and application tracking.
              </p>
              <Link href="/help-center" className="inline-block">
                <Button variant="link" className="text-primary mt-4 px-0 font-bold hover:underline">
                  Visit Help Center →
                </Button>
              </Link>
            </div>
              ...
              <CardContent className="p-4 pt-4 sm:p-8 sm:pt-6">
                <WkForm onSubmit={handleSubmit}>
                  <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <WKInput name="firstName" label="First Name" placeholder="e.g. John" required />
                    <WKInput name="lastName" label="Last Name" placeholder="e.g. Doe" required />
                  </div>
