...
export default function EmployerPricingView() {
  ...
  const mapDbPlanToCardProps = (plan: any) => {
    ...
    let displayPrice = plan.price === 0 ? '৳0' : `৳${plan.price.toLocaleString()}`;
    ...
    } else if (nameLower.includes('enterprise') || nameLower.includes('ultimate')) {
      icon = Shield;
              ...
              <div className="space-y-6 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground mx-auto max-w-2xl text-sm sm:text-base">
                    Choose the plan that fits your current needs. You can always upgrade as you
                    grow.
                  </p>
                </div>
              </div>
