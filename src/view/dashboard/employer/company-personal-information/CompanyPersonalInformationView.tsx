...
export default function CompanyPersonalInformationView({
  onBack,
    ...
    <div className="mx-auto max-w-5xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2 text-lg">
            Manage your individual account holder details and identity.
          </p>
        </div>
      ...
      >
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-lg font-medium">Account Avatar</h3>
        ...
        <div className="space-y-6 lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Update your personal identification and communication channels.
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your specific role or title within the company account.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-2">
