...
export default function CompanySecurityView({ onBack }: CompanySecurityViewProps) {
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground text-sm">
                  Ensure your company account uses a unique password not shared with other services.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6 lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Update your company account password.</CardDescription>
            </CardHeader>
            <CardContent>
