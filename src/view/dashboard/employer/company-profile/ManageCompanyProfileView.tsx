    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="px-4 py-8 sm:px-6 lg:px-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full space-y-8">
          {/* Tab list */}
          <TabsList className="bg-muted/40 border-border flex h-11 w-full scrollbar-none flex-nowrap justify-start gap-1 overflow-x-auto rounded-full border p-1 sm:h-12">
