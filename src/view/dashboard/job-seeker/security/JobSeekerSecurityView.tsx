...
export default function JobSeekerSecurityView({ onBack }: JobSeekerSecurityViewProps) {
  ...
  const handleUpdatePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(
        error.data?.message || error.data?.errorSources?.message || 'Failed to update password',
      );
    }
  };
