...
const AdminLegalEditorView = ({ title: defaultTitle, slug }: AdminLegalEditorViewProps) => {
  const { data, isLoading } = useGetLegalDocumentQuery(slug);
  const [upsertLegalDocument, { isLoading: isSaving }] = useUpsertLegalDocumentMutation();
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-muted-foreground text-sm italic">
                    Note: You can use HTML tags here for formatting (e.g. &lt;h2&gt;, &lt;ul&gt;,
                    &lt;strong&gt;).
                  </p>
                  <WKTextArea
                    name="content"
