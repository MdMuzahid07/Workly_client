                ...
                <div className="border-border/40 mt-6 flex items-center justify-between border-t pt-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Link href={page.href}>
                      <Button
                        size="sm"
                        className="h-8 gap-2 rounded-lg font-bold"
                      >
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  All your legal documents are up to date and comply with the
                  latest platform standards.
                </p>
              </div>
            </div>
            <Button
