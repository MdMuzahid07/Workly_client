...
const buildReceiptText = (mapped: MappedTransaction, raw: RawTransaction): string => {
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto rounded-2xl sm:max-w-lg">
        <DialogHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-base font-bold">Transaction Details</DialogTitle>
        ...
        <div className="flex gap-2 pt-2">
          <Button
            ...
            onClick={() => {
              downloadTextFile(`receipt-${raw.tranId}.txt`, buildReceiptText(mapped, raw));
...
export function TransactionTable({ transactions, rawTransactions }: TransactionTableProps) {
