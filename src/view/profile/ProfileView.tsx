...
const ProfileView = () => {
  ...
  const [volunteerToDeleteIndex, setVolunteerToDeleteIndex] = useState<number | null>(null);
  ...
  const [awardToDeleteIndex, setAwardToDeleteIndex] = useState<number | null>(null);
    ...
    setLocalProfile((prev: any) => {
      ...
      const nextLanguages =
        typeof idOrIndex === 'string'
          ...
          : prevLanguages.filter((_: any, index: number) => index !== idOrIndex);
    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="space-y-4 px-3 sm:space-y-6 sm:px-6 lg:space-y-8 lg:px-8">
              ...
              <div className="relative -mt-14 mb-4 shrink-0">
                ...
                >
                  {localProfile?.avatarUrl || user?.profile?.avatarUrl ? (
                    <Image
                      src={
                        localProfile?.avatarUrl || user?.profile?.avatarUrl || '/placeholder.svg'
                      }
                      alt="User"
                      width={96}
                      height={96}
        ...
        <Tabs defaultValue="personal" className="w-full pb-10">
          <div className="mb-4 w-full scrollbar-none overflow-x-auto sm:mb-6">
            <TabsList className="bg-muted/30 border-border/50 flex h-10 w-full min-w-max gap-1 rounded-full border p-1 whitespace-nowrap lg:grid lg:h-12 lg:min-w-0 lg:grid-cols-4 lg:whitespace-normal">
              ...
              >
                <User className="h-3.5 w-3.5 sm:h-4 sm:w-4" /> Personal & Portfolio
              </TabsTrigger>
              <TabsTrigger
                value="professional"
                className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground text-muted-foreground hover:text-foreground inline-flex h-full w-full shrink-0 items-center justify-center gap-1.5 rounded-full px-4 text-xs font-semibold transition-all lg:w-full lg:shrink lg:px-5 lg:text-sm"
              ...
              <TabsTrigger
                ...
                className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground text-muted-foreground hover:text-foreground inline-flex h-full w-full shrink-0 items-center justify-center gap-1.5 rounded-full px-4 text-xs font-semibold transition-all lg:w-full lg:shrink lg:px-5 lg:text-sm"
              >
                <GraduationCap className="h-3.5 w-3.5 sm:h-4 sm:w-4" /> Education & Growth
              </TabsTrigger>
              <TabsTrigger
                value="skills"
                className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground text-muted-foreground hover:text-foreground inline-flex h-full w-full shrink-0 items-center justify-center gap-1.5 rounded-full px-4 text-xs font-semibold transition-all lg:w-full lg:shrink lg:px-5 lg:text-sm"
              >
                <LayoutGrid className="h-3.5 w-3.5 sm:h-4 sm:w-4" /> Skills & Preferences
              </TabsTrigger>
            </TabsList>
          </div>

          {/*  Personal & Portfolio Tab */}
          <TabsContent value="personal" className="animate-in fade-in-50 space-y-8 duration-300">
            {/* Basic Info */}
            <SectionCard
            ...
            >
              <div className="grid grid-cols-1 gap-x-12 gap-y-6 md:grid-cols-2">
                <div>
                  ...
                  <div className="font-medium">{localProfile?.fullName || user?.fullName}</div>
                </div>
                <div>
                  <div className="text-muted-foreground mb-1 text-xs tracking-wider uppercase">
                    Email
                  </div>
                  <div className="font-medium">{localProfile?.email || user?.email}</div>
                </div>
                <div>
                  <div className="text-muted-foreground mb-1 text-xs tracking-wider uppercase">
                    Phone
                  </div>
                  <div className="font-medium">{localProfile?.phone || 'Not provided'}</div>
                </div>
                <div>
                  <div className="text-muted-foreground mb-1 text-xs tracking-wider uppercase">
                    Location
                  </div>
                  <div className="font-medium">{localProfile?.location || 'Not provided'}</div>
                </div>
            ...
            <PortfolioSection
              ...
              onAddVideoResume={() => {
                if (!user?.isPremium) {
                  toast.error('Video Resume is a premium feature. Please upgrade your account.');
                  return;
                }
                  ...
                  <div>
                    ...
                    <div className="text-foreground text-sm font-medium">
                      {localProfile.address.zipCode && localProfile.address.country
                        ? `${localProfile.address.zipCode}, ${localProfile.address.country}`
                        : localProfile.address.zipCode || localProfile.address.country || 'N/A'}
                    </div>
                  </div>
                </div>
              ) : (
          ...
          <TabsContent value="education" className="animate-in fade-in-50 space-y-8 duration-300">
            <EducationList
          ...
          <TabsContent value="skills" className="animate-in fade-in-50 space-y-8 duration-300">
            <SkillsManager
          ...
          <DialogHeader>
            <DialogTitle className="text-xl font-semibold">
              ...
              {activeModal === 'volunteer' &&
                (editingVolunteerIndex !== null ? 'Edit Volunteer Work' : 'Add Volunteer Work')}
              {activeModal === 'award' &&
                (editingAwardIndex !== null ? 'Edit Honor / Award' : 'Add Honor / Award')}
              {activeModal === 'publication' &&
                (editingPubIndex !== null ? 'Edit Publication' : 'Add Publication')}
          ...
          <div className="py-4">
                ...
                defaultValues={
                  editingEdu
                    ? {
                        ...
                        currentlyStudying:
                          editingEdu.currentlyStudying || editingEdu.current || false,
                      }
                    : undefined
                }
                onSubmit={async (data) => {
                  ...
                  const normalizedData = {
                    ...data,
                    year: data.year.includes('-') ? data.year.split('-')[0] : data.year,
                  };
                  if (editingEduIndex !== null && editingEduIndex !== undefined) {
                    const existing = (localProfile?.education || [])[editingEduIndex];
                    const updatedItem = {
                      ...existing,
                      ...normalizedData,
                    };
                    ...
                    newEdu = [...(localProfile?.education || []), normalizedData];
                  }
              ...
              <ExperienceForm
                defaultValues={
                  editingExperience
                    ? {
                        designation:
                          editingExperience.jobTitle || editingExperience.designation || '',
                        company: editingExperience.company || '',
                        employmentType: editingExperience.employmentType || 'Full-time',
                        location: editingExperience.location || '',
                        startDate: formatDateForInput(editingExperience.startDate),
                        endDate: formatDateForInput(editingExperience.endDate),
                        currentlyWorking:
                          editingExperience.currentlyWorking || editingExperience.current || false,
                ...
                onSubmit={async (data) => {
                  let newExp;
                  if (editingExperienceIndex !== null && editingExperienceIndex !== undefined) {
                    const existing = (localProfile?.workExperiences || [])[editingExperienceIndex];
                    const updatedItem = {
                      ...existing,
                      ...data,
            ...
            {activeModal === 'project' && (
              <ProjectForm
                ...
                onSubmit={async (data) => {
                  let newProj;
                  if (editingProjectIndex !== null && editingProjectIndex !== undefined) {
                    const existing = (localProfile?.projects || [])[editingProjectIndex];
                    const updatedItem = {
                      ...existing,
                      ...data,
                    };
            ...
            {activeModal === 'certification' && (
              <CertificationForm
                defaultValues={
                  editingCert
                    ? {
                        ...
                        organization: editingCert.issuingOrg || editingCert.organization || '',
                ...
                onSubmit={async (data) => {
                  let newCert;
                  if (editingCertIndex !== null && editingCertIndex !== undefined) {
                    const existing = (localProfile?.certifications || [])[editingCertIndex];
                    const updatedItem = {
                      ...existing,
                      ...data,
            ...
            {activeModal === 'social' && (
              <SocialLinksForm
                ...
                onSubmit={async (data) => {
                  ...
                  setActiveModal(null);
                  toast.success("Online presence updated! Click 'Save Changes' to persist.");
                }}
                onCancel={() => setActiveModal(null)}
              />
            )}
            {activeModal === 'video' && (
              <VideoResumeForm
                ...
                onSubmit={async (data) => {
                  ...
                  setActiveModal(null);
                  toast.success("Video resume updated! Click 'Save Changes' to persist.");
                }}
                onCancel={() => setActiveModal(null)}
              />
            )}
            ...
            {activeModal === 'address' && (
              <AddressForm
                ...
                onSubmit={async (data) => {
                  ...
                  toast.success("Address updated locally. Click 'Save Changes' to persist.");
                  setActiveModal(null);
                }}
                onCancel={() => setActiveModal(null)}
              />
            ...
            {activeModal === 'volunteer' && (
              <VolunteerForm
                defaultValues={
                  editingVolunteer
                    ? {
                        ...
                        startDate: formatDateForInput(editingVolunteer.startDate),
                ...
                onSubmit={async (data) => {
                  let newVol;
                  if (editingVolunteerIndex !== null && editingVolunteerIndex !== undefined) {
                    const existing = (localProfile?.volunteers || [])[editingVolunteerIndex];
                    const updatedItem = {
                      ...existing,
                      ...data,
            ...
            {activeModal === 'award' && (
              <AwardForm
                defaultValues={
                  editingAward
                    ? {
                        ...
                        organization: editingAward.issuer || editingAward.organization || '',
                        date: formatDateForInput(editingAward.issueDate || editingAward.date),
                ...
                onSubmit={async (data) => {
                  let newAward;
                  if (editingAwardIndex !== null && editingAwardIndex !== undefined) {
                    const existing = (localProfile?.awards || [])[editingAwardIndex];
                    const updatedItem = {
                      ...existing,
                      ...data,
            ...
            {activeModal === 'publication' && (
              <PublicationForm
                defaultValues={
                  editingPub
                    ? {
                        ...
                        date: formatDateForInput(editingPub.publishDate || editingPub.date),
                ...
                onSubmit={async (data) => {
                  let newPub;
                  if (editingPubIndex !== null && editingPubIndex !== undefined) {
                    const existing = (localProfile?.publications || [])[editingPubIndex];
                    const updatedItem = {
                      ...existing,
                      ...data,
                      link: data.url,
            ...
            {activeModal === 'reference' && (
              <ReferenceForm
                ...
                onSubmit={async (data) => {
                  let newRef;
                  if (editingRefIndex !== null && editingRefIndex !== undefined) {
                    const existing = (localProfile?.references || [])[editingRefIndex];
                    const updatedItem = {
                      ...existing,
                      ...data,
                    };
        ...
        onConfirm={async () => {
          if (experienceToDeleteIndex !== null) {
            setLocalProfile((prev: any) => {
              ...
              const nextExp = prevExp.filter((_: any, i: number) => i !== experienceToDeleteIndex);
              return { ...prev, workExperiences: nextExp };
            });
            toast.success("Experience deleted locally. Click 'Save Changes' to persist.");
          }
        }}
      />
        ...
        onConfirm={async () => {
          if (projectToDeleteIndex !== null) {
            setLocalProfile((prev: any) => {
              ...
              const nextProj = prevProj.filter((_: any, i: number) => i !== projectToDeleteIndex);
              return { ...prev, projects: nextProj };
            });
            toast.success("Project deleted locally. Click 'Save Changes' to persist.");
          }
        }}
      />
        ...
        onConfirm={async () => {
          if (volunteerToDeleteIndex !== null) {
            setLocalProfile((prev: any) => {
              ...
              const nextVol = prevVol.filter((_: any, i: number) => i !== volunteerToDeleteIndex);
              return { ...prev, volunteers: nextVol };
            });
            toast.success("Volunteer work deleted locally. Click 'Save Changes' to persist.");
          }
        }}
      />
        ...
        onConfirm={async () => {
          if (eduToDeleteIndex !== null) {
            setLocalProfile((prev: any) => {
              ...
              const nextEdu = prevEdu.filter((_: any, i: number) => i !== eduToDeleteIndex);
              return { ...prev, education: nextEdu };
            });
            toast.success("Education record deleted locally. Click 'Save Changes' to persist.");
          }
        }}
      />
        ...
        onConfirm={async () => {
          if (certToDeleteIndex !== null) {
            setLocalProfile((prev: any) => {
              ...
              const nextCert = prevCert.filter((_: any, i: number) => i !== certToDeleteIndex);
              return { ...prev, certifications: nextCert };
            });
            toast.success("Certification deleted locally. Click 'Save Changes' to persist.");
          }
        }}
      />
        ...
        onConfirm={async () => {
          if (awardToDeleteIndex !== null) {
            setLocalProfile((prev: any) => {
              ...
              const nextAward = prevAward.filter((_: any, i: number) => i !== awardToDeleteIndex);
              return { ...prev, awards: nextAward };
            });
            toast.success("Award deleted locally. Click 'Save Changes' to persist.");
          }
        }}
      />
        ...
        onConfirm={async () => {
          if (pubToDeleteIndex !== null) {
            setLocalProfile((prev: any) => {
              ...
              const nextPub = prevPub.filter((_: any, i: number) => i !== pubToDeleteIndex);
              return { ...prev, publications: nextPub };
            });
            toast.success("Publication deleted locally. Click 'Save Changes' to persist.");
          }
        }}
      />
        ...
        onConfirm={async () => {
          if (refToDeleteIndex !== null) {
            setLocalProfile((prev: any) => {
              ...
              const nextRef = prevRef.filter((_: any, i: number) => i !== refToDeleteIndex);
              return { ...prev, references: nextRef };
            });
            toast.success("Reference deleted locally. Click 'Save Changes' to persist.");
          }
        }}
      />
    </div>
