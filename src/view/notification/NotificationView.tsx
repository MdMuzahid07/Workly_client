...
import { Bell, BellRing, Briefcase, Calendar, MessageSquare } from 'lucide-react';
...
const NotificationView = () => {
  ...
  const { data: envelope, isLoading: isNotifLoading } = useGetMyNotificationsQuery(
    { page: 1, limit: 100 },
  ...
  const filteredNotifications = notifications.filter((notification) => {
    ...
    if (activeTab === 'applications')
      return ['APPLICATION_RECEIVED', 'APPLICATION_STATUS_CHANGE', 'INTERVIEW_SCHEDULED'].includes(
        notification.type,
      );
