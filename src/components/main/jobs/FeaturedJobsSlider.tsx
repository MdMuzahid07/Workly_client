        ...
        <div className="relative z-10 flex-1 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="text-muted-foreground flex flex-wrap items-center gap-x-2 gap-y-1 text-xs font-semibold">
              ...
              <span className="font-bold text-emerald-600 dark:text-emerald-400">{salaryStr}</span>
              <span className="text-muted-foreground/30">•</span>
    ...
    <div className="relative mt-12 overflow-hidden">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-foreground text-xl font-bold tracking-tight">Featured Positions</h2>
        </div>
