...
const Searchbar = () => {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl p-4 md:mt-24">
      <form className="flex flex-col gap-2 rounded-2xl border border-gray-200 bg-white p-2 shadow-sm sm:flex-row">
        ...
        <Button
          size="sm"
          className="h-10 cursor-pointer rounded-xl bg-green-400 px-6 text-lg font-semibold hover:bg-green-500"
        >
          Search
        </Button>
      </form>
