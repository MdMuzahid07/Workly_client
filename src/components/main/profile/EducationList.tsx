              ...
              >
                <div className="grid w-full grid-cols-1 gap-3 sm:gap-4 md:grid-cols-2">
                  <div>
                    ...
                    <div className="text-sm font-semibold sm:text-base">{edu.level}</div>
                  </div>
                  <div>
                    <div className="text-muted-foreground mb-1 text-[10px] tracking-wider uppercase sm:text-xs">
                      Exam/Degree Title
                    </div>
                    <div className="text-sm font-semibold sm:text-base">{edu.degree}</div>
                  </div>
                  <div>
                    <div className="text-muted-foreground mb-1 text-[10px] tracking-wider uppercase sm:text-xs">
                  ...
                  <div className="flex gap-6 sm:gap-8">
                    <div>
                      ...
                      <div className="text-sm font-semibold sm:text-base">{edu.year}</div>
                    </div>
                    <div>
                      <div className="text-muted-foreground mb-1 text-[10px] tracking-wider uppercase sm:text-xs">
                        Result
                      </div>
                      <div className="text-sm font-semibold sm:text-base">{edu.result}</div>
                    </div>
                  </div>
                </div>
      ...
      >
        {certifications.length === 0 ? (
          <div className="text-muted-foreground py-6 text-center text-sm">
            No certifications added yet. Highlight your skills with certifications.
          </div>
        ) : (
          <div className="space-y-3 sm:space-y-4">
            {certifications.map((cert, index) => (
              ...
              >
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold sm:text-base">{cert.name}</h4>
