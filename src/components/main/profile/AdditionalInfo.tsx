...
import type { Award as AwardType, Publication, Reference } from '@/types/profile';
...
export const AdditionalInfo = ({
  ...
  return (
    <div className="space-y-6">
      <SectionCard title="Honors & Awards" isCompleted={awards.length > 0} onAdd={onAddAward}>
        {awards.length > 0 ? (
            ...
            {awards.map((award, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold sm:text-base">{award.title}</h4>
            ...
            {publications.map((pub, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold sm:text-base">{pub.title}</h4>
                    <p className="text-muted-foreground text-xs sm:text-sm">
                      {pub.publisher}{' '}
      ...
      <SectionCard title="References" isCompleted={references.length > 0} onAdd={onAddReference}>
        {references.length > 0 ? (
          <div className="space-y-4">
            {references.map((ref, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold sm:text-base">{ref.name}</h4>
                    <p className="text-muted-foreground text-xs sm:text-sm">
