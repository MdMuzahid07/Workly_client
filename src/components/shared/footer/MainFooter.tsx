      ...
      <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-6">
        ...
        <div className="col-span-2 md:col-span-3 lg:col-span-2">
          <div className="mb-6 flex items-center gap-2">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-green-400">
          ...
          <div className="flex items-center gap-4">
            <a
              href="#"
              className="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-100 transition-all hover:bg-green-400 hover:text-white"
            >
        ...
        {/* Jobs */}
        <div>
          <h4 className="mb-4 font-bold text-gray-900">Jobs</h4>
        ...
        {/* Companies */}
        <div>
          <h4 className="mb-4 font-bold text-gray-900">Companies</h4>
          <ul className="space-y-3">
            <li>
              <a
                href="#"
