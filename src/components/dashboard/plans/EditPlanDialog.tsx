...
const EditPlanDialog = ({ open, onOpenChange, plan, onSuccess }: EditPlanDialogProps) => {
      ...
      <DialogContent className="sm:max-w-[600px]">
        ...
        <WkForm
          ...
          defaultValues={{
            ...
            firstTimeDiscountPercent: (plan.firstTimeDiscountPercent ?? 0).toString(),
          }}
        >
          <div className="custom-scrollbar grid max-h-[60vh] gap-4 overflow-y-auto px-1 py-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <WkInput name="price" label="Monthly Price ($)" type="number" required />
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button type="button" onClick={handleAddFeature} size="icon" className="shrink-0">
          ...
          <DialogFooter className="border-t pt-4">
            ...
            <Button type="submit" className="bg-primary rounded-full px-8 font-bold">
              Save Changes
            </Button>
          </DialogFooter>
        </WkForm>
