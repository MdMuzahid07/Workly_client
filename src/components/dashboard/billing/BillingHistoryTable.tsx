      ...
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            Review and download all your past premium plan transactions and
            invoices.
          </p>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <Card className="flex flex-col items-center justify-center border-dashed p-12 text-center">
          ...
          <p className="text-muted-foreground mt-1 max-w-sm text-sm">
            You {`haven't`} made any paid premium transactions yet. Upgrades
            will list here immediately.
          </p>
        </Card>
      ) : (
            ...
            <table className="w-full border-collapse text-left text-sm">
              ...
              <tbody className="divide-border divide-y">
                {transactions.map((tx: any) => (
                  ...
                  >
                    <td className="text-foreground p-4 font-mono text-xs font-bold">
                      {tx.tranId}
                    </td>
        ...
        <div className="bg-background/80 animate-in fade-in fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-sm duration-300">
          <Card className="border-border bg-background relative w-full max-w-xl overflow-hidden border p-8 shadow-2xl">
            ...
            <div
              ...
              className="text-foreground space-y-6 text-sm"
            >
              ...
              <div className="bg-primary/5 border-primary/10 flex items-center justify-between rounded-xl border p-4">
                <span className="text-foreground text-md font-extrabold">
                  Total Paid Amount
                </span>
