...
export function EmployerRecentJobs({ jobs, isLoading }: EmployerRecentJobsProps) {
  return (
    <Card className="bg-card border">
      <CardHeader>
        <CardTitle className="text-base sm:text-lg">Recent Job Postings</CardTitle>
            ...
            {jobs.map((job) => (
              ...
              >
                <div className="min-w-0 flex-1 space-y-1">
                  <p className="truncate text-sm font-bold sm:text-base">{job.title}</p>
