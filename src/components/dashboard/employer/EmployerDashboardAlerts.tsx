  ...
  return (
    <>
      {noCompanyAssigned && (
        ...
        >
          <h2 id="employer-dashboard-no-company-heading" className="text-foreground font-medium">
            No company is linked to this account yet.
          </h2>
          <p className="text-muted-foreground mt-1">
            Complete company onboarding to unlock job posting and hiring analytics.
          </p>
        </section>
      )}
      ...
      {partialError && (
        <div
          ...
          role="alert"
        >
          <p>Part of your dashboard failed to load. You can retry or refresh the page.</p>
          <Button
            type="button"
            variant="outline"
            size="sm"
