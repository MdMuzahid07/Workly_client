...
import { STAFF_ROLE_DEFINITIONS, STAFF_ROLE_OPTIONS } from '@/constants/adminStaffPermissions';
import type { AdminStaffRole, AdminStaffRow } from '@/types/adminStaff';
import { CheckCircle2, Info, Key, Loader2, ShieldAlert, ShieldCheck } from 'lucide-react';
...
const AdminStaffPermissionsDialog = ({
  ...
  const canEditRole =
    currentUserRole === 'SUPER_ADMIN' && staff != null && staff.id !== currentUserId;
            ...
            <div className="flex-1 space-y-5 overflow-y-auto px-6 pb-4">
              {canEditRole ? (
                <div className="space-y-3">
                  ...
                  <RadioGroup
                    value={draftRole}
                    onValueChange={(value) => setDraftRole(value as AdminStaffRole)}
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-muted-foreground text-xs">
                    ...
                    <span className="text-foreground font-medium">{roleDefinition.label}</span>
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-2">
                    {roleDefinition.restricted.map((restriction) => (
                      <li key={restriction} className="flex items-start gap-2 text-sm">
