...
export const VideoResumeForm = ({ onSubmit, onCancel, defaultValues }: VideoResumeFormProps) => {
  ...
  const handleUploadFile = async () => {
    ...
    try {
      ...
      setUploadError('Failed to upload video. Please try again or use a video URL instead.');
      setUploadProgress(0);
    }
  };
  ...
  return (
    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
      <div className="space-y-2">
        <label className="text-sm leading-none font-medium">Add Video Resume</label>
        <p className="text-muted-foreground mb-4 text-xs">
          Share a link to your video (YouTube, Vimeo, etc.) or upload a file directly.
        </p>
