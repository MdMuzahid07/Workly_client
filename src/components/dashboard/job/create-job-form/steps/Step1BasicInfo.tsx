...
export default function Step1BasicInfo({ categories, categoriesLoading }: Step1BasicInfoProps) {
  return (
    <div className="animate-in fade-in-50 space-y-6 duration-300">
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          />
          <SubcategorySelect categories={categories} categoriesLoading={categoriesLoading} />
        </div>
