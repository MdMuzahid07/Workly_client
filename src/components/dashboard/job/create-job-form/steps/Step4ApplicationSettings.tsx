...
export default function Step4ApplicationSettings() {
  ...
  return (
    <div className="animate-in fade-in-50 space-y-6 duration-300">
      <div>
        <h2 className="text-foreground text-lg font-semibold">Application Settings</h2>
        <p className="text-muted-foreground mt-1 text-sm">Configure how candidates can apply</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          <div>
            <p className="text-foreground text-sm font-semibold">Additional Settings</p>
            <p className="text-muted-foreground mt-1 text-xs">
              Optional configurations to customize your posting visibility and automation.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            >
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-foreground text-xs font-bold">Feature Job Posting</p>
                  <p className="text-muted-foreground mt-1 text-[10px] leading-normal">
                    Pin your listing to the top of search results and highlight it for maximum
                    candidate views.
                  </p>
                </div>
              </div>
            ...
            <div
              onClick={() => setValue('autoCloseApplications', !autoCloseApplications)}
              className={cn(
                'bg-card flex cursor-pointer items-start justify-between gap-4 rounded-2xl border p-4 text-left transition-all duration-200 select-none',
            ...
            >
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-foreground text-xs font-bold">Auto-Close Applications</p>
                  <p className="text-muted-foreground mt-1 text-[10px] leading-normal">
                    Automatically stop accepting new applications once the maximum applicant cap is
                    reached.
                  </p>
                </div>
              </div>
        ...
        <div className="space-y-4">
          <div>
            <p className="text-foreground text-sm font-semibold">Publication Status</p>
            <p className="text-muted-foreground mt-1 text-xs">
              ...
              <div>
                <p
                  className={cn(
                    ...
                    statusValue === 'DRAFT' ? 'text-primary' : 'text-foreground',
                  )}
                >
                  Save as Draft
                </p>
                <p className="text-muted-foreground mt-1 text-[11px] leading-relaxed">
                  Visible only to your team. Candidates cannot view or apply to this job yet.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                <p
                  className={cn(
                    'text-xs font-bold transition-colors',
                    statusValue === 'ACTIVE' ? 'text-primary' : 'text-foreground',
                  )}
                >
                  Publish Immediately
                </p>
                <p className="text-muted-foreground mt-1 text-[11px] leading-relaxed">
                  Publish active listing. Candidates will immediately see it and can submit
                  applications.
                </p>
              </div>
            </div>
