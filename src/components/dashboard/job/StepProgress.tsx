...
export default function StepProgress({ steps, currentStep, onStepChange }: StepProgressProps) {
  return (
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      isUpcoming && 'border-muted-foreground/20 bg-muted text-muted-foreground/60',
                    )}
                  >
                    {isCompleted ? (
