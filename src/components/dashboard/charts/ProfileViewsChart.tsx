...
export function ProfileViewsChart({
  ...
  const isControlled =
    externalPeriod !== undefined && onPeriodChange !== undefined;
  ...
  const { data: statsData, isFetching: internalFetching } =
  ...
  const isLoading =
    externalData !== undefined ? externalLoading : internalFetching;
