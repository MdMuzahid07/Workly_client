    ...
    <div className="mt-24 space-y-12 pb-20">
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <p className="text-muted-foreground">
          Everything you need to know about our job seeker subscription packages.
        </p>
      </div>

      <div className="mx-auto grid max-w-4xl gap-8 sm:grid-cols-2">
        {CANDIDATE_PRICING_FAQ.map((item, idx) => (
          <div key={idx} className="bg-card space-y-3 rounded-xl border p-6 shadow-xs">
      ...
      <div className="bg-primary/5 border-primary/20 mt-12 rounded-3xl border border-dashed p-8 text-center">
        ...
        <p className="text-muted-foreground mt-2 text-sm">
          Our support team is always here to help. Contact us for assistance with candidate
          packages.
        </p>
        <Button
          variant="outline"
