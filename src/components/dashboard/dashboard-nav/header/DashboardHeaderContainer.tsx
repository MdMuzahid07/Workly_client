...
const DashboardHeaderContainer = ({ children }: { children: ReactNode }) => {
  ...
  const handleToggleSidebar = () => {
    // We keep the real Sheet triggers inside sidebars (hidden),
  ...
  return (
    <header className="border-border bg-card/95 sticky top-0 z-50 border-b shadow-sm backdrop-blur-sm">
      <div className="mx-auto flex h-16 shrink-0 items-center justify-between gap-3 px-4 py-3 sm:h-18 sm:px-6 sm:py-4 lg:px-8">
        <Button
          variant="ghost"
          size="icon"
