...
const notificationApi = baseApi.injectEndpoints({
  ...
  endpoints: (builder) => ({
    getMyNotifications: builder.query<Envelope<NotificationItem[]>, GetMyNotificationsArgs | void>({
      query: (args) => ({
        url: '/notification/my',
        method: 'GET',
        params: args ?? {},
    ...
    markAllNotificationsRead: builder.mutation<Envelope<{ updated: number }>, void>({
      query: () => ({
