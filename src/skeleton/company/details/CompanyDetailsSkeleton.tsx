    ...
    <CardContent className="p-4 pt-0 sm:p-6 sm:pt-0">
      <div className="grid grid-cols-1 gap-4">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="border-primary/10 flex items-center gap-4 rounded-2xl border p-4"
          >
    ...
    <CardContent className="p-4 pt-0 sm:p-6 sm:pt-0">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="border-primary/10 flex flex-col gap-3 rounded-2xl border p-5"
          >
    ...
    <CardContent className="p-4 pt-0 sm:p-6 sm:pt-0">
      <div className="space-y-4">
        {[1, 2].map((i) => (
          <div
            key={i}
            className="border-primary/10 space-y-3 rounded-2xl border p-4 sm:p-5"
          >
    ...
    <Card className="border-primary/10 bg-background/50 border backdrop-blur-sm">
      ...
      <CardContent className="space-y-3 p-4 pt-0 sm:p-6 sm:pt-0">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="border-primary/10 flex items-center gap-3 rounded-xl border p-3"
          >
            <Skeleton className="h-8 w-8 shrink-0 rounded-lg" />
            <Skeleton className="h-4 w-24 rounded" />
    ...
    <Card className="border-primary/10 bg-background/50 border backdrop-blur-sm">
      ...
      <CardContent className="space-y-4 p-4 pt-0 sm:p-6 sm:pt-0">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="border-primary/10 space-y-2 rounded-xl border p-3"
          >
