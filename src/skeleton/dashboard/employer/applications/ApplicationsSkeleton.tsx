      ...
      <div className="space-y-6 px-4 sm:px-6 sm:py-8">
        ...
        <div className="bg-card rounded-2xl border p-4 shadow-xs sm:p-6 md:p-8">
          <Tabs value="all" className="w-full">
            <TabsList className="bg-muted/30 border-border h-auto w-full scrollbar-none flex-nowrap justify-start gap-1.5 overflow-x-auto rounded-2xl border p-1 sm:w-auto">
              {['All', 'Submitted', 'Reviewing', 'Shortlisted', 'Interviewed', 'Rejected'].map(
                (label, idx) => (
                  <TabsTrigger
                    key={idx}
