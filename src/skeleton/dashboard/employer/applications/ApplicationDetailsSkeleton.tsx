      ...
      <div className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="space-y-2">
            {/* Back button */}
            <Button variant="ghost" disabled className="text-muted-foreground -ml-3 gap-2">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Skeleton className="h-10 w-28 rounded-full" /> {/* Move to Status skeleton */}
            <Button variant="outline" disabled className="border-border rounded-full">
