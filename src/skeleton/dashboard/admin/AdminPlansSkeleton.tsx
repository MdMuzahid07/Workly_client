...
export default function AdminPlansSkeleton({ showTransactions = false }: AdminPlansSkeletonProps) {
  return (
          ...
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
              {Array.from({ length: 3 }).map((_, i) => (
                <Card key={i} className="bg-card space-y-4 rounded-xl border p-6 shadow-none">
